...
italian_job = media.Movie(
    "The Italian Job",
    "After being betrayed and left for dead in Italy, Charlie Croker \
and his team plan an elaborate gold heist against their former ally.",
    "https://upload.wikimedia.org/wikipedia/en/d/db/Italianjob.jpg",
    "https://www.youtube.com/watch?v=7HZndLdQOPk",
    "2003")
green_mile = media.Movie(
    "The Green Mile",
    "The lives of guards on Death Row are affected by one of their \
charges: a black man accused of child murder and rape, yet who has \
a mysterious gift.",
    "https://upload.wikimedia.org/wikipedia/en/c/ce/Green_mile.jpg",
    "https://www.youtube.com/watch?v=Ki4haFrqSrw",
    "1999")
law_abiding_citizen = media.Movie(
    "Law Abiding Citizen",
    "A frustrated man decides to take justice into his own hands after \
    a plea bargain sets one of his family's killers free. He targets \
    not only the killer but also the district attorney and others \
    involved in the deal.",
    "https://upload.wikimedia.org/wikipedia/en/9/95/Law_abiding_\
citizen_ver5.jpg",
